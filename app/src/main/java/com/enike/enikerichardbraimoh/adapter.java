...
public class adapter extends RecyclerView.Adapter<Viewholder>  {
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, final int position) {
        ...
        holder.email.setText((first_name.get(position))+(last_name.get(position)));
        holder.gender.setText((first_name.get(position))+(last_name.get(position)));
        holder.country.setText((first_name.get(position))+(last_name.get(position)));
        holder.jobtitle.setText((first_name.get(position))+(last_name.get(position)));
        holder.bio.setText((first_name.get(position))+(last_name.get(position)));
        holder.aboutcar.setText((first_name.get(position))+(last_name.get(position)));
